...
export const ALL_50_MENTOR_KNOWLEDGE: Record<number, ProblemMentorKnowledge> = {
  ...
  51: {
    greeting: "Welcome! Let's conquer Two Sum. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Arrays & Two Pointers",
  ...
  52: {
    greeting: "Welcome! Let's conquer Container With Most Water. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Arrays & Two Pointers",
    ...
    interviewTrap: "Watch out for boundary conditions, empty inputs, and duplicate elements.",
    hints: [
      { tier: 1, title: "The Problem Goal", nudge: "Understand the problem goal for Container With Most Water: Read space-separated integers representing heights. Calculate the maximum area of water the container can store: min(h[l], h[r]) * (r - l). Print the maximum integer area.", reflectionQuestion: "💡 Tip: State the inputs and expected outputs clearly before coding." },
  ...
  53: {
    greeting: "Welcome! Let's conquer 3Sum. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Arrays & Two Pointers",
    ...
    interviewTrap: "Watch out for boundary conditions, empty inputs, and duplicate elements.",
    hints: [
      { tier: 1, title: "The Problem Goal", nudge: "Understand the problem goal for 3Sum: Read space-separated integers. Find all unique triplets that sum to 0. Print each triplet sorted ascending on its own line (space-separated), and print the triplets sorted lexicographically. If none, print 'NONE'.", reflectionQuestion: "💡 Tip: State the inputs and expected outputs clearly before coding." },
  ...
  54: {
    greeting: "Welcome! Let's conquer 3Sum Closest. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Arrays & Two Pointers",
  ...
  55: {
    greeting: "Welcome! Let's conquer 4Sum. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Arrays & Two Pointers",
  ...
  56: {
    greeting: "Welcome! Let's conquer Longest Substring Without Repeating Characters. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Strings & Parsing",
  ...
  57: {
    greeting: "Welcome! Let's conquer Longest Palindromic Substring. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Strings & Parsing",
  ...
  58: {
    greeting: "Welcome! Let's conquer Zigzag Conversion. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Strings & Parsing",
    ...
    interviewTrap: "Watch out for boundary conditions, empty inputs, and duplicate elements.",
    hints: [
      { tier: 1, title: "The Problem Goal", nudge: "Understand the problem goal for Zigzag Conversion: Read string s on line 1, and integer numRows on line 2. Print the string formed by reading the zigzag pattern row by row.", reflectionQuestion: "💡 Tip: State the inputs and expected outputs clearly before coding." },
  ...
  59: {
    greeting: "Welcome! Let's conquer String to Integer (atoi). I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Strings & Parsing",
  ...
  60: {
    greeting: "Welcome! Let's conquer Longest Common Prefix. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Strings & Parsing",
    ...
    interviewTrap: "Watch out for boundary conditions, empty inputs, and duplicate elements.",
    hints: [
      { tier: 1, title: "The Problem Goal", nudge: "Understand the problem goal for Longest Common Prefix: Read space-separated strings from input. Find the longest common prefix shared by all words. Print the prefix string (or empty if none).", reflectionQuestion: "💡 Tip: State the inputs and expected outputs clearly before coding." },
  ...
  61: {
    greeting: "Welcome! Let's conquer Reverse Integer. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Math & Numerical Logic",
    conceptExplanation: "Digit extraction and 32-bit range verification runs in O(log_10 x) time and O(1) space.",
    patternExample: "x = int(input())\n\nsign = -1 if x < 0 else 1\nrev = int(str(abs(x))[::-1]) * sign\n\nif rev < -2**31 or rev > 2**31 - 1:\n    print(0)\nelse:\n    print(rev)\n",
    interviewTrap: "Watch out for boundary conditions, empty inputs, and duplicate elements.",
    hints: [
      { tier: 1, title: "The Problem Goal", nudge: "Understand the problem goal for Reverse Integer: Read an integer x. Reverse its digits while preserving the sign. If the reversed value exceeds [-2^31, 2^31 - 1], print 0.", reflectionQuestion: "💡 Tip: State the inputs and expected outputs clearly before coding." },
  ...
  62: {
    greeting: "Welcome! Let's conquer Palindrome Number. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Math & Numerical Logic",
    ...
    interviewTrap: "Watch out for boundary conditions, empty inputs, and duplicate elements.",
    hints: [
      { tier: 1, title: "The Problem Goal", nudge: "Understand the problem goal for Palindrome Number: Read an integer x. Return True if it reads identically forwards and backwards. Print 'True' or 'False'.", reflectionQuestion: "💡 Tip: State the inputs and expected outputs clearly before coding." },
  ...
  63: {
    greeting: "Welcome! Let's conquer Integer to Roman. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Math & Numerical Logic",
    ...
    interviewTrap: "Watch out for boundary conditions, empty inputs, and duplicate elements.",
    hints: [
      { tier: 1, title: "The Problem Goal", nudge: "Understand the problem goal for Integer to Roman: Read an integer num (1 <= num <= 3999). Convert it to a Roman numeral string and print it.", reflectionQuestion: "💡 Tip: State the inputs and expected outputs clearly before coding." },
  ...
  64: {
    greeting: "Welcome! Let's conquer Roman to Integer. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Math & Numerical Logic",
    ...
    interviewTrap: "Watch out for boundary conditions, empty inputs, and duplicate elements.",
    hints: [
      { tier: 1, title: "The Problem Goal", nudge: "Understand the problem goal for Roman to Integer: Read a Roman numeral string. Convert and print the integer value.", reflectionQuestion: "💡 Tip: State the inputs and expected outputs clearly before coding." },
  ...
  65: {
    greeting: "Welcome! Let's conquer Median of Two Sorted Arrays. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Math & Numerical Logic",
  ...
  66: {
    greeting: "Welcome! Let's conquer Add Two Numbers. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Lists, Stacks & Dynamic Programming",
  ...
  67: {
    greeting: "Welcome! Let's conquer Remove Nth Node From End of List. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Lists, Stacks & Dynamic Programming",
  ...
  68: {
    greeting: "Welcome! Let's conquer Valid Parentheses. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Lists, Stacks & Dynamic Programming",
    conceptExplanation: "LIFO stack matching achieves optimal O(n) time and O(n) space.",
    patternExample: "s = input()\n\nmapping = {')': '(', '}': '{', ']': '['}\nstack = []\nvalid = True\n\nfor char in s:\n    if char in mapping:\n        top = stack.pop() if stack else '#'\n        if mapping[char] != top:\n            valid = False\n            break\n    else:\n        stack.append(char)\n\nif valid and not stack:\n    print(\"True\")\nelse:\n    print(\"False\")\n",
    interviewTrap: "Watch out for boundary conditions, empty inputs, and duplicate elements.",
    hints: [
      { tier: 1, title: "The Problem Goal", nudge: "Understand the problem goal for Valid Parentheses: Read string s containing brackets. Print 'True' if all brackets are properly paired and closed in sequence, otherwise 'False'.", reflectionQuestion: "💡 Tip: State the inputs and expected outputs clearly before coding." },
  ...
  69: {
    greeting: "Welcome! Let's conquer Letter Combinations of a Phone Number. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Lists, Stacks & Dynamic Programming",
  ...
  70: {
    greeting: "Welcome! Let's conquer Regular Expression Matching. I'll guide you step-by-step with clear logic and optimal complexity!",
    conceptName: "Advanced Lists, Stacks & Dynamic Programming",
